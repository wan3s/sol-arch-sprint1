...
Вопросы можно обсуждать со стейкхолдерами. Если есть вопросы по продукту, то можно провести интервью с клиентами - нашими покупателями. Также можно посмотреть, как работает у конкурентов.

### Основные этапы проекта

1. Проводим fit/gap анализ для промежуточного и целевого решений.
2. Составляем концептуальные архитектуры промежуточного и целевого решений.
3. Найти Лабораторию, которая будет проводить анализ.
4. Найти провайдера частного облака для публикации данных для клиентов.
5. Настроить интеграции ИС Лаборатория с ИС Аукцион и с ИС Бухгалтерия
